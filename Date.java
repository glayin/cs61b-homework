...
private	 int year;
   ...
   */
	  public Date(int month, int day, int year) {
		 if(!isValidDate1(month,day,year))
			  System.exit(0);
		  this.month=month;
		  this.day=day;
		  this.year=year;
...
if (isValidDate1(Integer.parseInt(o[0]), Integer.parseInt(o[1]),Integer.parseInt(o[2])));
	{
   ...
   */
public static boolean isValidDate1 (int month, int day, int year) {
	if (year < 1) {
		return false;
  ...
  public int dayInYear() {
   int n=0;//记得定义
    for(int i=1; i<this.month; i++) {
    	n=daysInMonth(i,this.year)+n;// replace this line with your solution
    }
    n +=this.day;
    return n;
